...
Otherwise, we compute t by using the equation 'dot(normal, p) = d' where p is a point on the plane and d the offset, replacing p by the ray equation 'O+Dt' and then solving for t.
