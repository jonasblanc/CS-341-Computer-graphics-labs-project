export const SCENES = [
  ...
  },
  {
    ...
    lights: [{ position: [0, 0, 0.1], color: [1.0, 0.4, 0.2] }],
    spheres: [],
    planes: [
  ...
  },
  {
    ...
    lights: [{ position: [0, 0, 0], color: [1.0, 0.4, 0.2] }],
    spheres: [{ center: [0, 0, 7], radius: 1, material: "white" }],
    planes: [],
    cylinders: [
      {
        center: [0.0, 0.0, 0.0],
...
export const SCENES_BY_NAME = Object.fromEntries(
  SCENES.map((sc) => [sc.name, sc])
);
